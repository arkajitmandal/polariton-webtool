...
var plot = function(){
    ...
    // Gradient for 1
    var gradientStroke1 = ctx.createLinearGradient(0, 0, w*0.8, 0);
    gradientStroke1.addColorStop(0, '#000000');
    gradientStroke1.addColorStop(1, '#000000');

    // Gradient for 2
    var gradientStroke2 = ctx.createLinearGradient(0, 0, w*0.8, 0);
    gradientStroke2.addColorStop(0,   '#80b6f4');

    var gradientStroke3 = ctx.createLinearGradient(0, 0, w*0.8, 0);
